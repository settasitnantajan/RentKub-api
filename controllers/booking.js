...
exports.retryPayment = async (req, res, next) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "payment",
      success_url: `${process.env.CLIENT_URL || "https://rentkub.vercel.app"}/user/complete/{CHECKOUT_SESSION_ID}?retry=true&booking_id=${booking.id}`,
      cancel_url: `${process.env.CLIENT_URL || "https://rentkub.vercel.app"}/user/myorders?payment_cancelled=true&booking_id=${booking.id}`,
...
exports.checkout = async (req, res, next) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      return_url: `${
        process.env.CLIENT_URL || "https://rentkub.vercel.app"
